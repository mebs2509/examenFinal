...
namespace Univesidad.MVC.Controllers
{
    public class AlumnoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlumnoId,Codigo,ApellidoPaterno,ApellidoMaterno,Nombres,GeneroId,EstadoCivilId")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlumnoId,Codigo,ApellidoPaterno,ApellidoMaterno,Nombres,GeneroId,EstadoCivilId")] Alumno alumno)
        {
            if (ModelState.IsValid)
            {
